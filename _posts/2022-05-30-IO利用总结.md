...
fsop更像是一种工具，在2.31一下的版本都是首选，即便是之前的版本，2.23和2.27还是有些区别
...
方案二：一个是IO_file_jumps+0x60(要执行的函数)，一个IO_2_1_stderr，system(/bin/sh)
...
`house of kiwi`的主要利用链：

assert -> malloc_assert -> fflush -> _IO_file_jumps+0x60(__IO_file_sync)
