...
之前用了近1年的hexo博客，自己修修改改了许多，但总觉得不够正式，不太适合搞学术。第一次接触jekyll，用的是jekyll+githubpages，再用cdn加速的方案，选择的是[Chirpy](https://github.com/cotes2020/jekyll-theme-chirpy)主题。搭建过程中还是遇到了不少问题，国内资料比较少，这里就简单聊聊。
...
参照官方文档[Getting Started | Chirpy (cotes.page)](https://chirpy.cotes.page/posts/getting-started/)开一个仓库，然后gitclone下来，在本地打开终端
